...
<table>
  ...
  <tr>
    ...
    <td align="center">Data / Infra</td>
  </tr>
  <tr>
    <td align="center">프로젝트 총괄<br/>서비스 기획<br/>루틴 플로우</td>
    <td align="center">React 화면 구현<br/>운동 라이브러리 UI<br/>루틴 대시보드</td>
    <td align="center">Django API<br/>인증/세션 관리<br/>루틴 저장</td>
    <td align="center">LangGraph 추천<br/>RAG 챗봇<br/>SSE 스트리밍</td>
    <td align="center">운동 데이터 구축<br/>PostgreSQL/Neo4j<br/>Docker 인프라</td>
  </tr>
</table>
...
- 헬스장 운동을 시작하거나 루틴을 재정비하려는 사용자
- 통증이나 부상 이력 때문에 특정 운동을 조심해야 하는 사용자
- 운동 목표는 있지만 요일, 시간, 장비 조건에 맞춘 루틴 설계가 어려운 사용자
- 운동 이름, 자세, 호흡, 주의사항을 빠르게 찾아보고 싶은 사용자

**무엇을 원하는가**

- 내 운동 목표와 컨디션에 맞는 주간 루틴
- 통증 부위를 우회하는 안전한 대체 운동
- 운동별 영상, 타겟 부위, 난이도, 기구, 자세 가이드
- 상담 히스토리와 주간 루틴 수행 기록을 저장하는 지속성
...
1. 사용자가 기본 정보와 운동 목표를 입력합니다.
2. 통증 부위와 사용 가능한 장비를 선택합니다.
3. 운동 요일과 요일별 타겟 부위를 설정합니다.
4. AI가 그래프 검색 후보를 바탕으로 주간 루틴을 생성합니다.
5. 사용자는 추천안을 검토하고 수정 요청을 남길 수 있습니다.
6. 확정된 루틴은 주차별로 저장되고, 완료 체크와 메모를 남길 수 있습니다.
